...
void *Area(void *tid){
    int id = *((int *)tid);
    double h = 2.0 / retangulos;
    double somaParcial = 0.0;
    double x;

//cada thread fica responsável por uma operação, pulando de n em n threads até calcular a área de todos os retângulos
    ...
    printf("Sou a thread %d assumindo o controle\n", id);
